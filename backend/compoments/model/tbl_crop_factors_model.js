...
CropFactors.updateById = (id, cropfactors, result) => {
	sql.query(
		...
		[
			cropfactors.userid,
			cropfactors.member_id,
			cropfactors.land_improvement,
			cropfactors.land_improvement_costs,
			cropfactors.type_of_seed_name,
			cropfactors.type_of_seed_beds_no,
			cropfactors.type_of_seed_cost,
			cropfactors.type_of_seed_buy_shop,
			cropfactors.manure_name,
			cropfactors.manure_beds_no,
			cropfactors.manure_cost,
			cropfactors.manure_manpower,
			cropfactors.manure_buy_shop,
			cropfactors.pesticides_type,
			cropfactors.pesticides_frequency_of_spraying,
			cropfactors.pesticides_manpower,
			cropfactors.pesticides_cost,
			cropfactors.pesticides_buy_shop,
			cropfactors.types_of_crops_grown_and_acreage,
			cropfactors.harvesting_and_threshing_own,
			cropfactors.harvesting_and_threshing_rental,
			cropfactors.harvesting_and_threshing_type,
			cropfactors.harvesting_and_threshing_manpower,
			cropfactors.harvesting_and_threshing_savings_costs,
			cropfactors.harvesting_and_threshing_device_name,
			cropfactors.one_acre_output,
			cropfactors.total_yield,
			cropfactors.sales_fair_or_dealer,
			cropfactors.sales_fair_or_dealer_price_received,
			cropfactors.isloan,
			cropfactors.loan_person,
			cropfactors.is_seed_loan,
			cropfactors.seen_loan_person,
			cropfactors.is_fertilizer_loan,
			cropfactors.fertilizer_loan_person,
			id,
		],
		(err, res) => {
			if (err) {
