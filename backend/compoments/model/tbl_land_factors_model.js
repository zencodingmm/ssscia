...
LandFactors.updateById = (id, landfactors, result) => {
	sql.query(
		...
		[
			landfactors.userid,
			landfactors.member_id,
			landfactors.number_of_map,
			landfactors.own,
			landfactors.rent,
			landfactors.acreage,
			landfactors.pitch_no,
			landfactors.ownership_no,
			landfactors.land_type,
			landfactors.acres_of_land_owned,
			landfactors.acres_of_land_ground,
			landfactors.form_seven_form_onehundredfive_acres_of_contract,
			landfactors.form_seven_acres_of_applied,
			landfactors.names_of_neighbor_of_farm_east,
			landfactors.names_of_neighbor_of_farm_west,
			landfactors.names_of_neighbor_of_farm_south,
			landfactors.names_of_neighbor_of_farm_north,
			landfactors.number_of_family_members_by_grandparents,
			landfactors.apply_family_one_name,
			landfactors.apply_family_one_nrc,
			landfactors.apply_family_two_name,
			landfactors.apply_family_two_nrc,
			landfactors.time_value,
			landfactors.photo_form_seven,
			landfactors.photo_form_onehundredfive,
			landfactors.photo_contract,
			landfactors.photo_ancestral_property,
			landfactors.photo_other,
			landfactors.photo_household_chart,
			id,
		],
		(err, res) => {
			if (err) {
